  ...
  return (
    ...
    >
      ...
      <ButtonGroup isAttached={true}>
        ...
        {/* <IAIIconButton
          icon={<IoImagesSharp />}
          tooltip={`${t('parameters.useSeed')}`}
          aria-label={`${t('parameters.useSeed')} `}
          // isDisabled={!currentImage?.metadata?.image?.seed}
          onClick={handleClickUseAsInitialImage}
        /> */}
        {/* <IAIIconButton
          ...
          aria-label={`${t('parameters.sendToUnifiedCanvas')} `}
          onClick={handleSendToCanvas}
        />
        <IAIIconButton
          icon={<FaDownload />}
          href={currentImage?.url} aria-label={''} /> */}
        <IAIPopover
          triggerComponent={
            <IAIIconButton
      ...
      <DeleteImageModal image={currentImage}>
        <IAIIconButton
          icon={<FaTrash />}
          tooltip={`${t('parameters.deleteImage')}`}
